...
public class HttpRequest extends CustomJavaAction<java.lang.String>
{
	...
	public HttpRequest(IContext context, java.lang.String url, java.lang.String httpMethod, java.lang.String bodyContent, IMendixObject requestParameters)
	{
		super(context);
		this.url = url;
	...
	public static String setGetParameters(IContext context, String url, FunctionParameters parameters) throws URISyntaxException {
		...
		parameters.getMendixObject().getMetaObject().getDeclaredMetaPrimitives().forEach((primitive) -> {
			...
			case "Integer":
				...
				break;
			case "Long":
				String longValue = mapLong(value, attributeMapping.get(odataAttrName.toLowerCase()));
				builder.addParameter(odataAttrName, longValue);
				break;
			case "Decimal":
	...
	protected static String mapLong(Object value, String odataType) {
		String nonNullOdataType = odataType != null ? odataType : "";

		switch (nonNullOdataType) {
		case "Edm.Int64":
			return new StringBuilder(value.toString()).append("l").toString();
