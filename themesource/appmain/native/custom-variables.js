...
export const tabContainer = {
    tabBar: {
        ...
        backgroundColor: darkMode ? background.primary : brand.primary,
    },
    tab: {
        paddingVertical: 12
    },
    indicator: {
        backgroundColor: darkMode ? '#fff' : background.primary,
        height: Platform.select({ ios: 2, android: 2 })
    },
    label: {
        color: darkMode ? contrast.high : background.primary,
        fontSize: font.size,
        fontWeight: font.weightSemiBold,
        textTransform: "capitalize"
    },
    activeLabel: {
        color: darkMode ? '#fff' : background.gray,
        fontSize: font.size,
        fontWeight: font.weightSemiBold,
        textTransform: "capitalize"
    },
